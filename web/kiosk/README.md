...
The ASP.NET Core service serves a static fallback kiosk from `services/trackside/Trackside.Service/wwwroot` for packaged operation. This folder is the frontend development workspace: React components, typed API contracts, SignalR client wiring, and Vite build tooling.
