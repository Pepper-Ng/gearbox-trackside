...
Current proof-of-concept notes live in `docs/core-poc.md`. The Phase 0B scaffold structure and extension guide lives in `docs/scaffold-guide.md`. The telemetry report PoC decision plan, including central-server versus rig-local collector testing, lives in `docs/telemetry-report-poc-plan.md`.
